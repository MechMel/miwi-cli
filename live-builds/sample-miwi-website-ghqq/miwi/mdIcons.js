"use strict";
function _isIcon(possibleIcon) {
  return exists(possibleIcon == null ? void 0 : possibleIcon.icon);
}
function _buildIconsObj(unformattedIcons) {
  ...
  return readonlyObj(formattedIcons);
}
const _numIconTag = `i_`;
const _iconsObj = _buildIconsObj([
  "i_123",
  "i_3d_rotation",
  "abc",
  "accessibility",
